...
(LLMs) effortlessly—either through direct calls or via reusable minimal
wrappers.
...
result<- interpreter_agent(output_text)
```
...
<!--html_preserve-->
<iframe 
src="inst/assets/forecast_light_plot.html" 
style="
  width:100%;
  height:300px;
...
<!--html_preserve-->
<iframe 
src="inst/assets/forecast_dark_plot.html" 
style="
  width:100%;
  height:300px;
  /* solid black 2-px border */
...
<!--html_preserve-->
<iframe 
src="inst/assets/monthly_charges_vs_churn.html" 
style="
  width:100%;
  height:300px;
  /* solid black 2-px border */
