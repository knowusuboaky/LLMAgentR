...
[![Rmd Check](https://github.com/knowusuboaky/LLMAgentR/actions/workflows/rmd-check.yaml/badge.svg)](https://github.com/knowusuboaky/LLMAgentR/actions/workflows/rmd-check.yaml)
<!-- badges: end -->
...
```{r interpreter-agent, eval=FALSE}
library(LLMAgentR)
